...
def load_test_loader(opt):
    ...
    test_dataset = MultimodalAADBDataset(
...
if __name__ == "__main__":
    ...
    # 单个权重测试（取消注释使用）
    # ckpt_path = '/home/dmc/12TB_ZHZ68JLF/A_PROJECT_IAA/CheckPoints/MyWork/AADB/HKD-IAA-AGREE/epoch_014.pth'
