...
def init():
    parser = argparse.ArgumentParser(description="PyTorch EAMB-Net AGREE Training - AVA")
    
    # 数据路径 (AVA)
    parser.add_argument('--path_to_images', type=str,
                        default='/home/dmc/12TB_ZHZ68JLF/A_PROJECT_IAA/IAADatasets/AVA/AVA_dataset/image/',
                        help='directory to images')
    parser.add_argument('--path_to_save_csv', type=str,
                        default="/home/dmc/12TB_ZHZ68JLF/A_PROJECT_IAA/IAADatasets/AVA/AVA_dataset/AVAdata/",
                        help='directory to csv_folder')
    parser.add_argument('--path_to_text_features', type=str,
                        default='/home/dmc/12TB_ZHZ68JLF/A_PROJECT_IAA/IAADatasets/AVA/AVA_dataset/text_features/',
                        help='directory to pre-extracted text features')
    parser.add_argument('--path_to_save_ckpt', type=str,
                        default='/home/dmc/12TB_ZHZ68JLF/A_PROJECT_IAA/CheckPoints/MyWork/AVA/EAMB-Net-AGREE/',
