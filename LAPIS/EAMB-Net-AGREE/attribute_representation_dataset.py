...
def test_attribute_dataset():
    ...
    # 配置路径 (请根据实际情况修改)
    csv_path = "/home/dmc/12TB_ZHZ68JLF/A_PROJECT_IAA/IAADatasets/LAPIS/annotation/processed/train.csv"
    images_path = "/home/dmc/12TB_ZHZ68JLF/A_PROJECT_IAA/IAADatasets/LAPIS/images/"
