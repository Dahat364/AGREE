...
def init():
    parser = argparse.ArgumentParser(description="PyTorch HKD-IAA AGREE Training - LAPIS")
    ...
    parser.add_argument('--path_to_save_ckpt', type=str,
                        default='/home/dmc/12TB_ZHZ68JLF/A_PROJECT_IAA/CheckPoints/MyWork/LAPIS/HKD-IAA-AGREE/',
