...
def init():
    parser = argparse.ArgumentParser(description="PyTorch EAMB-Net AGREE Training - PARA")
    ...
    parser.add_argument('--path_to_save_ckpt', type=str,
                        default='/home/dmc/12TB_ZHZ68JLF/A_PROJECT_IAA/CheckPoints/MyWork/PARA/EAMB-Net-AGREE/',
