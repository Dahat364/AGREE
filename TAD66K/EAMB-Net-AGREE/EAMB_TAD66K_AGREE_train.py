...
print(f"\n{'='*80}")
print(f"🚀 EAMB-Net AGREE训练脚本 - TAD66K (不含HMAI指标)")
...
def create_data_part(opt):
    ...
    train_ds = MultimodalTAD66KDataset(os.path.join(csv_root, 'train.csv'), images_path, text_root, if_train=True)
    val_ds = MultimodalTAD66KDataset(os.path.join(csv_root, 'val.csv'), images_path, text_root, if_train=False)
