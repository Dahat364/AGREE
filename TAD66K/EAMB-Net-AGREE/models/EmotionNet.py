...
class resnet_base(nn.Module):
    def __init__(self, loadweights=True):
        ...
        resnet50Pretrained = models.resnet50(pretrained=False)  # 不使用默认预训练
        if loadweights:
            state_dict = torch.load('/home/dmc/12TB_ZHZ68JLF/A_PROJECT_IAA/weights/EMBA-NET/resnet50-0676ba61.pth')
            resnet50Pretrained.load_state_dict(state_dict)
