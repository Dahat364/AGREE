...
def init():
    parser = argparse.ArgumentParser(description="PyTorch EAMB-Net AGREE Training - TAD66K")
    
    # 数据路径 (TAD66K)
    parser.add_argument('--path_to_images', type=str,
                        default='/home/dmc/12TB_ZHZ68JLF/A_PROJECT_IAA/IAADatasets/TAD66K/images/',
                        help='directory to images')
    parser.add_argument('--path_to_save_csv', type=str,
                        default="/home/dmc/12TB_ZHZ68JLF/A_PROJECT_IAA/IAADatasets/TAD66K/labels/merge/processed/",
                        help='directory to csv_folder')
    parser.add_argument('--path_to_text_features', type=str,
                        default='/home/dmc/12TB_ZHZ68JLF/A_PROJECT_IAA/IAADatasets/TAD66K/text_features/',
                        help='directory to pre-extracted text features')
    parser.add_argument('--path_to_save_ckpt', type=str,
                        default='/home/dmc/12TB_ZHZ68JLF/A_PROJECT_IAA/CheckPoints/MyWork/TAD66K/EAMB-Net-AGREE/',
