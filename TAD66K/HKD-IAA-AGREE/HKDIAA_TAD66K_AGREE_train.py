...
from multimodal_dataset import MultimodalTAD66KDataset
...
print(f"\n{'='*80}")
print(f"🚀 HKD-IAA AGREE训练脚本 - TAD66K (不含HMAI指标)")
...
def create_data_part(opt):
    ...
    train_dataset = MultimodalTAD66KDataset(os.path.join(csv_root, 'train.csv'), images, text_root, if_train=True)
    val_dataset = MultimodalTAD66KDataset(os.path.join(csv_root, 'val.csv'), images, text_root, if_train=False)
