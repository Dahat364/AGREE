...
class MultimodalTAD66KDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        # image_c = row['dataset']
        # image_path = os.path.join(self.images_path, f"{image_c}_{image_id}")
        ...
        # text_feature_id = f"{image_c}_{image_id_clean}"
