...
def init():
    parser = argparse.ArgumentParser(description="PyTorch HKD-IAA AGREE Training - TAD66K")
    ...
    parser.add_argument('--path_to_save_ckpt', type=str,
                        default='/home/dmc/12TB_ZHZ68JLF/A_PROJECT_IAA/CheckPoints/MyWork/TAD66K/HKD-IAA-AGREE/',
